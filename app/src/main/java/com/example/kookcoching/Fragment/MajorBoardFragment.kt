...
import kotlinx.android.synthetic.main.fragment_major_board.*
import kotlinx.coroutines.*
import kotlinx.coroutines.selects.select
import kotlinx.coroutines.tasks.await

// 2020.11.14 / 문성찬 / 전공 게시판 프래그먼트 구현
class MajorBoardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_major_board, container, false)
        ...
        val spinner = view!!.findViewById(R.id.major_spinner) as Spinner
        // Inflate the layout for this fragment

        // 2020.11.02 / 문성찬 / spinner 어댑터 설정
        var selectedTag : String = ""
        val items = resources.getStringArray(R.array.major_board)
        spinner.adapter = ArrayAdapter(
            activity as Context,
            R.layout.support_simple_spinner_dropdown_item,
            resources.getStringArray(R.array.major_board)
        )
        ...
        btn_move.setOnClickListener {
            activity?.let {
                ...
                intent.putExtra("chip_type", "major")
        ...
        scope.launch {
            val deferred : Deferred<QuerySnapshot?> = async {
                ...
                var docRef = firestore!!.collection("major_post").get()
